...
MODEL_NAME = 'export_ssd_mobilenet_v3_large'
...
PATH_TO_CKPT = os.path.join(curr_dir, f'packages/tfObjWebrtc/{MODEL_NAME}/frozen_inference_graph.pb')

# List of the strings that is used to add correct label for each box.
PATH_TO_LABELS = os.path.join(curr_dir, 'packages/tfObjWebrtc/object_detection/data/mscoco_label_map.pbtxt')
...
def get_objects(image_np, threshold=0.5):
    ...
    # outputJson = json.dumps(str([ob.__dict__ for ob in output]))
    return output
